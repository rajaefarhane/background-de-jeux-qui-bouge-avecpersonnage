...
function startGame() {
    ...
    myGamePiece = new component(70, 70, "img/ir2.png", 700, 245, "image");
    myScore = new component("30px", "Consolas", "red", 1200, 50, "text");
...
function updateGameArea() {
    ...
    myScore.text="SCORE: " + Math.floor(null);
